...
export function genTriadicPalette(col) {
...
export function genAnalogousPalette(col, angle = defaultAnalogousAngle) {
...
export function genTetradicPalette(col) {
    const { h, s, l, a } = col.hsl;
    const h1 = (h + 60) % 360;
    const h2 = (h + 180) % 360;
    const h3 = (h + 240) % 360;
...
export function genQuadraticPalette(col) {
    const { h, s, l, a } = col.hsl;
    const h1 = (h + 90) % 360;
    const h2 = (h + 180) % 360;
    const h3 = (h + 270) % 360;
